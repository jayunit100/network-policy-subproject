...
- [KEP-NNNN: Your short, descriptive title](#kep-nnnn-your-short-descriptive-title)
  ...
  - [Proposal](#proposal)
    - [User Stories (Optional)](#user-stories-optional)
      - [Nodes as First Class Policy Citizens](#nodes-as-first-class-policy-citizens)
      - [Templated Policies](#templated-policies)
      - [CLI Command Schema](#cli-command-schema)
...
- cluster administrators need APIs beyond current devloper focused APIs for
  securing the cluster, not just apps
...
#### Nodes as First Class Policy Citizens

Secure communication between pods and other endpoints, additionally, bind
policies to named endpoint groups (synthetic labels for non k8s native workloads)

#### Templated Policies

#### CLI Command Schema

Common command line interface regardless of CNI implementation for policy introspection.
